...
export async function initBackgroundRemovalEditor(cesdk: CreativeEditorSDK) {
  ...
  //
  // TODO: Replace this URL with a self-hosted scene or CDN-hosted asset.
  // The showcases URL works for now but should be updated for production use.
  await cesdk.loadFromURL(
    'https://img.ly/showcases/cesdk/cases/background-removal/scene.scene'
  );
}
